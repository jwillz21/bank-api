...
return [
    ...
    'baseUrl' => (env('APP_ENV') !== 'sandbox') ? 'https://tartan.plaid.com/':'https://api.plaid.com/',
    'client_id' => (env('APP_ENV') !== 'sandbox') ? 'test_id':env('PLAID_CLIENT_ID'),
    'secret' => (env('APP_ENV') !== 'sandbox') ? 'test_secret':env('PLAID_SECRET'),
    'prefix' => 'plaid',
